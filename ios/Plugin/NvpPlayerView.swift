...
class VideoPlayerView: UIView, UIGestureRecognizerDelegate {
    ...
    let pauseImage = NvpResoucesLoader().getImage(named: "pause")!
    let playImage = NvpResoucesLoader().getImage(named: "play")!
    
    let pipinImage = NvpResoucesLoader().getImage(named: "pipin")!
    let fullScreenImage = NvpResoucesLoader().getImage(named: "fullscreen")!
