...
//  NvpSideMenu.swift
//
//  Created by snuffy on 2021/02/14
//  Copyright © 2021年 snuffy. All rights reserved.
//
...
class SideMenuView: UIView {
    ...
    lazy var volumeSlider: ControlSlider = {
        ...
        guard let image = NvpResoucesLoader().getImage(named: "slider") else {return slider}
    ...
    override init(frame: CGRect) {
        ...
        // volume slider
        let volumeImage = NvpResoucesLoader().getImage(named: "speaker")
        ...
        // スピード
        let speedImage = NvpResoucesLoader().getImage(named: "speed")
        ...
        // 輝度
        let brightnessImage = NvpResoucesLoader().getImage(named: "brightness")
